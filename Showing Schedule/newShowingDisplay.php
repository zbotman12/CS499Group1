...
<body>
	...
	<div class="container-fluid">
		...
		<div class="availability">
			<b>Available Times for Showing Agent and Listing:</b>
			<br/>
			<?php
				for($x=0;$x<95;$x++){
					$inc=1;
		...
		<form name="scheduleForm" action="/Helpers/Showing Schedule/newShowingDataHandle.php" method="post">
			...
			<input style="margin: auto" class="button btn-default btn" type="submit" value="Submit" name="Submit" onClick="return isTimeValid(totalTimes, hour_keys)"/>
