...
-- Schema ParagonMLS
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `ParagonMLS` ;
...
CREATE TABLE IF NOT EXISTS `ParagonMLS`.`Listings` (
  ...
  `agent_only_info` VARCHAR(318) NULL,
...
CREATE TABLE IF NOT EXISTS `ParagonMLS`.`Showings` (
  ...
  `showing_agent_name` VARCHAR(300) NULL,
  `showing_agent_company` VARCHAR(300) NULL,
